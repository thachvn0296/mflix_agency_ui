...
import {locationPicker, handSet} from './option';
import './style.scss';
  ...
  render() {
    return (<div className="create-form-wrapper container-fluid">
      <div className="col-sm-12 form-panel" id="1">
        <BasicInfoForm onFocus={(e) => {
            console.log("OK")
          }} badge={1} title={`BASIC INFO`} forms={[
            {
              title: 'Campaign name',
              name: 'campaignName',
              required: true
      ...
      <div className="col-sm-12 form-panel">
        ...
        <div className="col-sm-12 form-panel">
          <CreativeForm badge={3} title={`CREATIVE`}/>
        </div>

        <div className="col-sm-12 btn-box-wrapper">
          <button className="btn special-button">Submit Campaign</button>
        </div>
      </div>
    </div>)
  }
